...
## 
## Makefile     : Model.mk
## Generated on : Tue Aug 29 08:50:13 2023
...
DEFINES_STANDARD = -DMODEL=Model -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Model_grt_rtw\Model.c $(START_DIR)\Model_grt_rtw\Model_data.c
...
Model.obj : "$(START_DIR)\Model_grt_rtw\Model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Model_grt_rtw\Model.c"


Model_data.obj : "$(START_DIR)\Model_grt_rtw\Model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Model_grt_rtw\Model_data.c"
